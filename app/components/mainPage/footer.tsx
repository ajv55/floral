...
export default function Footer() {
  return (
    <footer className=" bg-gradient-to-tl from-amber-800 via-pink-600 to-pink-800 text-white py-10">
        ...
        <div className="flex  flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col md:flex-row md:space-x-8">
            <div className="mb-6 md:mb-0">
              ...
              <p>Call Us: <a href="tel:1-800-SWEETBLISS" className="text-indigo-300">1-800-SWEETBLISS</a></p>
              <p>Email: <a href="mailto:support@sweetblissbakery.com" className="text-indigo-300">support@sweetblissbakery.com</a></p>
              <p>Visit Us: 123 Baker Street, Your City, ST 12345</p>
            </div>
            <div>
              <h3 className="text-lg font-semibold">Follow Us on Social Media</h3>
              <div className="flex space-x-4 mt-2">
                <a href="https://instagram.com/sweetblissbakery" target="_blank" rel="noopener noreferrer" className="text-indigo-300 hover:text-indigo-200">
                ...
                <a href="https://facebook.com/sweetblissbakery" target="_blank" rel="noopener noreferrer" className="text-indigo-400 hover:text-indigo-300">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://pinterest.com/sweetblissbakery" target="_blank" rel="noopener noreferrer" className="text-indigo-400 hover:text-indigo-300">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
