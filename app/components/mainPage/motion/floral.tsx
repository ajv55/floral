...
export default function Floral() {
  ...
  return (
    <motion.div ref={ref}  variants={{visible: {x: 0, opacity: 1}}} initial={{x: '-20vw', opacity: 0}}  animate={mainContorls} transition={{duration: 1, delay: 1, stiffness: 120, type: 'spring'}} className="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div className="p-6">
            <h3 className="text-xl font-semibold text-gray-900">Elegant Floral Arrangements</h3>
