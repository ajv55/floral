  ...
  return (
    <div className="bg-white py-16 px-8">
        <div className="max-w-7xl mx-auto">
            <motion.h2 ref={ref} variants={{ visible: {x: 0}}} initial={{x: '-100%'}} animate={mainControls} transition={{duration: 1, type: 'spring', delay: 0.75, stiffness: 80}} className="text-5xl  font-extrabold bg-gradient-to-br from-amber-600 via-pink-400 to-pink-600 bg-clip-text text-transparent mb-32 text-center">Why Choose Sweet Bliss Bakery?</motion.h2>
            ...
            <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-2xl font-semibold bg-gradient-to-br from-amber-600 via-pink-400 to-pink-600 bg-clip-text text-transparent mb-2">Quality Ingredients</h3>
            ...
            <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-2xl font-semibold bg-gradient-to-br from-amber-600 via-pink-400 to-pink-600 bg-clip-text text-transparent mb-2">Custom Orders</h3>
            ...
            <div className="flex flex-col mb-20 items-center text-center">
                ...
                <h3 className="text-2xl font-semibold bg-gradient-to-br from-amber-600 via-pink-400 to-pink-600 bg-clip-text text-transparent mb-2">Local & Fresh</h3>
